...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header">
            <i class="bi bi-plus-circle"></i> Registra Nuovo Lavoro Svolto
        </div>
        <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-8">
                        ...
                        <textarea name="lavoro_svolto" id="lavoro_svolto" rows="4" 
                                  ...
                                  required>{{ old('lavoro_svolto') }}</textarea>
                        @error('lavoro_svolto')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" name="data_lavoro" id="data_lavoro" 
                               ...
                               value="{{ old('data_lavoro', date('Y-m-d')) }}" required>
                        @error('data_lavoro')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save"></i> Salva Lavoro
                        </button>
                        <a href="{{ route('lavori.index') }}" class="btn btn-secondary">
