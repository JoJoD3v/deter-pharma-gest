                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="number" name="numero_trattamento" id="numero_trattamento" 
                               ...
                               value="{{ old('numero_trattamento', $lavoro->numero_trattamento) }}" min="1" max="99" placeholder="1-12">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="tipo_ordine" id="tipo_ordine" class="form-select @error('tipo_ordine') is-invalid @enderror">
                            ...
                            <option value="Contratto" {{ old('tipo_ordine', $lavoro->tipo_ordine) == 'Contratto' ? 'selected' : '' }}>Contratto</option>
                            <option value="Email" {{ old('tipo_ordine', $lavoro->tipo_ordine) == 'Email' ? 'selected' : '' }}>Email</option>
                            <option value="Telefonico" {{ old('tipo_ordine', $lavoro->tipo_ordine) == 'Telefonico' ? 'selected' : '' }}>Telefonico</option>
                        </select>
                        @error('tipo_ordine')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-check mt-2">
                            <input class="form-check-input" type="checkbox" name="lavoro_extra" id="lavoro_extra" 
                                   value="1" {{ old('lavoro_extra', $lavoro->lavoro_extra) ? 'checked' : '' }}>
