    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('clienti.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select name="tipo_cliente" id="tipo_cliente" class="form-select @error('tipo_cliente') is-invalid @enderror" required>
                            <option value="fisica" {{ old('tipo_cliente') == 'fisica' ? 'selected' : '' }}>Persona Fisica</option>
                            <option value="giuridica" {{ old('tipo_cliente') == 'giuridica' ? 'selected' : '' }}>Persona Giuridica</option>
                        </select>
                        @error('tipo_cliente')
                ...
                <div id="persona-giuridica-fields" style="display: none;">
                    <div class="row mb-3">
                        <div class="col-md-12">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="partita_iva" id="partita_iva" 
                               ...
                               value="{{ old('partita_iva') }}" maxlength="11">
                        @error('partita_iva')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <textarea name="indirizzo" id="indirizzo" rows="3" 
                                  class="form-control @error('indirizzo') is-invalid @enderror">{{ old('indirizzo') }}</textarea>
                        @error('indirizzo')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
